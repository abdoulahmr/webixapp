...
class SnapchatRequest extends StatefulWidget {
  final int userID;
  const SnapchatRequest({super.key, required this.userID});

  @override
  State<SnapchatRequest> createState() => _SnapchatRequestState();
}

class _SnapchatRequestState extends State<SnapchatRequest> {
