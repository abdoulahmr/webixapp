...
class InstagramRequest extends StatefulWidget {
  final int userID;
  const InstagramRequest({super.key, required this.userID});

  @override
  State<InstagramRequest> createState() => _InstagramRequestState();
}

class _InstagramRequestState extends State<InstagramRequest> {
